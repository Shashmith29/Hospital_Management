...
<head>
    ...
    <?php echo '<link href="style5.css" rel="stylesheet">'; ?>
...
<body>
    <div class="formbold-main-wrapper">
        ...
        <div class="formbold-form-wrapper">
            ...
            <div class="formbold-mb-5 formbold-pt-3" id="formbold-mb-5 formbold-pt-3">
            ...
            <div class="container">
                <a href="book.php"><button type="submit" class="btn" onclick="openPopup()">Book Now</button></a>
